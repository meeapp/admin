...
var EventManagementPage = /** @class */ (function () {
    ...
    EventManagementPage.prototype.ionViewDidEnter = function () {
        ...
        this.eventService.heightTable = this.utilsService.settingTableHeight(this.appValueService.APP_TABULATOR_HEIGHT);
    };
